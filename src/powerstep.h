...
#define RESET      		 8  // Wire this to the STBY line
#define BUSYN      		 5   // Wire this to the BSYN line

#define STAT1            14  // Hooked to an LED on the test jig
#define STAT2            15  // Hooked to an LED on the test jig
#define SWITCH           0 // Hooked to the switch input and a pB on the jig
...
//cm_vm mode
#define VoltageMode     0x00
#define CurrentMode   	0x08
...
#define UVLOVAL0					   0x0000
#define UVLOVAL1					   0x0100

#define VCCVAL0						   0x0000
#define VCCVAL1						   0x0200
